    ...
    Node Frontend
    {
        ...
        Script OctopusDeployment
        {
            SetScript = {
                ...
                $tenantId = Invoke-Octopus /api/tenants/all?name=Environment |% GetEnumerator | % Id
                ...
                Set-Content -Path 'C:\Octopus.deploy' -Value 1
            }
            TestScript = { Test-Path 'C:\Octopus.deploy' }
            GetScript = { @{} }
